...
int main() {
    ...
    gettimeofday(&end,NULL); //gettimeofday(&start,&tz);结果一样
    time_use=(end.tv_sec-start.tv_sec)*1000000+(end.tv_usec-start.tv_usec);//微秒
	cout << "C_GE_OMP_Dynamic_AVX: " << time_use / 1000
		<< "ms" << endl;
	//show(m2, n);
    ...
    gettimeofday(&end,NULL); //gettimeofday(&start,&tz);结果一样
    time_use=(end.tv_sec-start.tv_sec)*1000000+(end.tv_usec-start.tv_usec);//微秒
	cout << "C_GE_OMP_Static_AVX: " << time_use / 1000
		<< "ms" << endl;
	//show(m2, n);
    ...
    gettimeofday(&end,NULL); //gettimeofday(&start,&tz);结果一样
    time_use=(end.tv_sec-start.tv_sec)*1000000+(end.tv_usec-start.tv_usec);//微秒
	cout << "C_GE_OMP_Guided_AVX: " << time_use / 1000
		<< "ms" << endl;
	//show(m2, n);
    ...
    gettimeofday(&end,NULL); //gettimeofday(&start,&tz);结果一样
    time_use=(end.tv_sec-start.tv_sec)*1000000+(end.tv_usec-start.tv_usec);//微秒
	cout << "C_GE_OMP_Dynamic_AUTO_SIMD: " << time_use / 1000
		<< "ms" << endl;
	//show(m2, n);
	...
	cout << "PThread_Dynamic_Block_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
	...
	cout << "PThread_Dynamic_Rotation_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
	...
	cout << "PThread_Static_OnlyElim_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
	...
	cout << "PThread_Static_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
	...
	cout << "PThread_Static_Barrier_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
	...
	cout << "PThread_Static_Barrier_Block_GE: " << time_use / 1000
		<< "ms" << endl;
	//show(mat, n);
